               ...
               <div class="">
                  ...
                  <div class="col-lg-6">
                     <div class="box box-primary edit_promoform1">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form"  method="post" action="<?php echo base_url('admin/round_package_add');?>">
                           <div class="box-body">
                              <div class="form-group">
                                 <label>Package</label>
                                 <input class="form-control regcom" placeholder="Package" name="package" required >
                              </div>
                              
                               <div class="form-group">
                                 <label>Pick Point</label>
                                 <input class="form-control regcom" placeholder="Pick Point" name="pick_point" required>
                              </div>
