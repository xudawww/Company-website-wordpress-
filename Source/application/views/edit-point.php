                  ...
                  <h3 class="box-title"></h3>
				   ...
				   <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control pull-right regcom datepicker"  name="pickup_date"  id="optionD" value="<?php echo $row->pickup_date; ?>" readonly>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
                  ...
                  <div class="col-lg-6">
                     <div class="box box-primary edit_promoform">
                        ...
                        <!-- form start -->
                           ...
                           <div class="box-body editpoint_height">
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <input class="form-control " name="transaction" value="<?php echo $row->transaction; ?>" readonly>
                              </div>
                              <div class="form-group">
                                 <label>Distance</label>
                                 <input class="form-control" name="distance" value="<?php echo $row->km; ?>" id="distance">
                              </div>
                              <div class="form-group">
                                 <label>Amount</label>
                              ...
                              <div class="form-group">
                                 ...
                                 <select id="assigned" class="form-control select2 regcom"  style="width: 100%;" name="assigned_for">
                                    <option value='0'>Select Driver</option>
                                    <?php
                                       $ids =$row->assigned_for;
                                       										if( $row->assigned_for){
                                       											echo $ids =$row->assigned_for;
