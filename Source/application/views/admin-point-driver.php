  ...
  <body class="hold-transition skin-blue sidebar-mini">
   ...
   <?php 
								...
								$s="";
								 ...
								 $query1 = $this->db->query("SELECT * FROM  bookingdetails WHERE purpose='Point to Point Transfer'  and (status='Processing' or status='Complete') and (item_status='Completed' or item_status='')  ORDER BY id DESC");
								?>
