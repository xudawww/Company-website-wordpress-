...
<html>
  ...
  <?php
								...
								$s="";
								if($paypal=='PayPal'){
								$s = "and item_status='Completed'";
								}
								 $query1 = $this->db->query("SELECT * FROM  bookingdetails WHERE purpose='Outstation Transfer'  and (status='Processing' or status='Complete') and (item_status='Completed' or item_status='')  ORDER BY id DESC");
								?>
       ...
       foreach($query1->result_array('userdetails') as $row1){
        ?>
                                        ...
                                        <tr class="odd gradeX" >
                                            ...
                                            <td class="center"><a href="#" class='status2'title="<?php echo $row1['id'];?>"><?php if($row1['status']!='Complete'){echo'<i class="fa fa-check-square-o"></i>';}?></a>&nbsp;&nbsp;<a href="#" title="<?php echo $row1['id'];?>" class="delete"><i class="fa fa-trash-o "></i></a></td>
                                        </tr>
                                       <?php
	   }
									?> 
