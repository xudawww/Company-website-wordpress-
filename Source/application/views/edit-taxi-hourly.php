                 ...
                 <form role="form"  method="post" id="taxi_reg">
                  ...
                  <div class="box-body">
                                        ...
                                        <div class="form-group">
                                           ...
                                           <select class="form-control regcom select2"  style="width: 100%;" id="package" name="package">
                                             <?php
										   	$query2 = $this->db->query("SELECT * FROM package_details");
                                                    foreach($query2->result_array('package_details') as $row1){
										   ?>
                                              <option value="<?php echo $row1['id'];?>" <?php if($row->package == $row1['id']) echo 'selected'; ?>  ><?php echo $row1['package'];?></option>
										...
										<div class="form-group">
                                            <label>Rate </label>
                                            <input class="form-control regcom" placeholder="145" name="standardrate"  id="extrahour" value="<?php echo $row->standardrate; ?>">
				  ...
				  <div class="box-footer">
                    ...
                    <input type="button" class="btn btn-primary" value="Save Details"  name="Save" id="taxiadd"> 
                     <!-- <input type="button" class="btn btn-primary" value="Reset"  name="Save" id="promoedit">-->
