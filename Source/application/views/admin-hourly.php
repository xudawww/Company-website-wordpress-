	 ...
	 ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Hourly Rental Transfer Details
          </h1>
          <ol class="breadcrumb">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
								...
								$s = "and item_status='Completed'";
								 ...
								 $query1 = $this->db->query("SELECT * FROM  bookingdetails WHERE purpose='Hourly Rental' and status='Booking' and (item_status='Completed' or item_status='')  ORDER BY id DESC");
								?>
       ...
       foreach($query1->result_array('userdetails') as $row1){
        ?>
                                        ...
                                        <tr class="odd gradeX" >
                                            ...
                                            <td class="center"><a href="<?php echo base_url();?>admin/edit_hourly?id5=<?php echo $row1['id'];?>"><i class="fa fa-pencil-square-o"></i></a>&nbsp;&nbsp;<a href="#" title="<?php echo $row1['id'];?>" class="delete"><i class="fa fa-trash-o "></i></a></td>
                                        </tr>
                                       <?php
	   }
									?> 
