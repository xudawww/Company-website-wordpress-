...
/** @var bool if set to false, kint will become silent, same as wpvrKint::enabled(false) or wpvrKint::$enabled = false */
...
/** @var bool enable detection when wpvrKint is command line. Formats output with whitespace only; does not HTML-escape it */
$_kintSettings['cliDetection'] = true;

/** @var bool in addition to above setting, enable detection when wpvrKint is run in *UNIX* command line.
