      ...
      <div class="content-wrapper">
        ...
        <!-- Main content -->
		 ...
		 $row = $query->row('bookingdetails');
								?>
                 <form role="form"  method="post" id="airport_reg">
				
                  <div class="box-body">
				  
                                         <div class="form-group">
                                            <label>Pickup Area</label>
                                           <input class="form-control regcom sample"  name="pickup_area" value="<?php echo $row->pickup_area; ?>" readonly>
                                         </div>
                                         <div class="form-group">
                                            <label>Drop Area</label>
                                           <input class="form-control regcom sample" name="drop_area"  value="<?php echo $row->drop_area; ?>" readonly>
                                         </div>
					 <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <div class="input-group-addon">
                          <i class="fa fa-clock-o"></i>
                                        ...
                                        <div class="form-group">
                                            <label>Area</label>
                                            <input class="form-control regcom sample" name="area" value="<?php echo $row->area; ?>" readonly>
                                            
                                        </div>
                                           
					
				      <div class="form-group">
                                        <input type="button" class="btn btn-primary" value="Save Details"  name="Save" id="airportedit">
                 ...
                 <h3 class="box-title"></h3>
                   ...
                   <div class="box-body">
					                     ...
					                     <div class="form-group">
                                            ...
                                            <input class="form-control  " name="landmark" value="<?php echo $row->flight_number; ?>" readonly>
										 ...
										 <div class="form-group">
                                            ...
                                            <input class="form-control regcom sample" name="distance" value="<?php echo $row->km; ?>" id="distance">
                                            
                                        </div>
					                      <div class="form-group">
                                            <label>Amount</label>
                                            <input class="form-control regcome sample"  name="amount" value="<?php echo $row->amount; ?>" id="amount">
...
$("#airportedit").click(function(){
 ...
 var value =$("#airport_reg").serialize() ;

$.ajax({
url:'<?php echo base_url();?>index.php/admin/update_point',
type:'post',
data:value,
