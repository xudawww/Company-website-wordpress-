				      ...
				      <div class="form-group">
                                       ...
                                       <h4><u>To Airport Transfer</u></h4>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input  id="transfertype" name="transfertype" type="hidden" value="Airport Transfer">
                                        </div>
                                         <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <input type="button" class="btn btn-primary" value="Submit Button"  name="Save" id="taxiadd">
                  ...
                  <div class="box-body">
					 ...
					 <div class="form-group">
                                       ...
                                       <h4><u>From Airport Transfer</u></h4>
                                         ...
                                         <div class="form-group">
                                            <label> Intial <?php if($measr=='mi'){echo "Miles";}else{echo $measr; }?></label>
                                            <input class="form-control regcom" placeholder="1" name="fromintialkm"  id="fromintialkm2">
                                           
                                        </div>
                                         <div class="form-group">
                                            <label class="intrate2"> Intial <?php if($measr=='mi'){echo "Miles";}else{echo $measr; }?> Rate</label>
                                            <input class="form-control regcom" placeholder="49" name="fromintailrate" id="fromintailrate">
                                        </div>
                                         <div class="form-group">
                                            <label> Standard Rate</label>
...
$(document).ready(function(){
	...
	$('#intialkm2').on('change', function (){
	 ...
	 var km ="<?php echo $row->measurements; ?>";
		$('.intrate').html('Intial '  +  a + km );
	});	
		
	$('#fromintialkm2').on('change', function (){
	    var a = $(this).val();
		var km ="<?php echo $row->measurements; ?>";
	    $('.intrate2').html('Intial '  +  a + km);
    });	
