...
<html>
 ...
 <?php
								 ...
								 $query1 = $this->db->query("SELECT * FROM  bookingdetails WHERE purpose='Airport Transfer'  and (status='Processing' or status='Complete') and (item_status='Completed' or item_status='') ORDER BY id DESC");
								?>
