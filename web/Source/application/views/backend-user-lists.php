...
<html>
 ...
 <?php
								 $query1 = $this->db->query("SELECT * FROM  adminlogin");
								?>
       ...
       foreach($query1->result_array('adminlogin') as $row1){
        ?>
                                        ...
                                        <tr class="odd gradeX" >
                                            ...
                                            <td class="center"><a href="<?php echo base_url();?>admin/edit_bakend_user?id2=<?php echo $row1['id'];?>" > <i class="fa fa-pencil-square-o"></i></a>&nbsp;&nbsp;<a href="#" title="<?php echo $row1['id'];?>" class="delete"><i class="fa fa-trash-o "></i></a></td>
                                        </tr>
                                       <?php
	   }
									?> 
   ...
   $(function () {
	   $(document).on('click',"#example1 .delete",function(){	
			...
			if (r == true) {
				...
				$.ajax({
					url:'<?php echo base_url();?>admin/delete_backend',
					type:'post',
					data:{'id':id},
