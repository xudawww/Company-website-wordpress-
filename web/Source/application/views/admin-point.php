       ...
       foreach($query1->result_array('userdetails') as $row1){
        ?>
                                        ...
                                        <tr class="odd gradeX" >
                                            ...
                                            <td class="center"><a href="<?php echo base_url();?>admin/edit_point?id3=<?php echo $row1['id'];?>"><i class="fa fa-pencil-square-o"></i></a>&nbsp;&nbsp;<a href="#" title="<?php echo $row1['id'];?>" class="delete"><i class="fa fa-trash-o "></i></a></td>
                                        </tr>
                                       <?php
	   }
									?> 
