                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                                <?php
								 ...
								 $query1 = $this->db->query("SELECT * FROM  bookingdetails WHERE purpose='Outstation Transfer' and status='Booking' and (item_status='Completed' or item_status='')  ORDER BY id DESC ");
								?>
       ...
       foreach($query1->result_array('userdetails') as $row1){
        ?>
                                        ...
                                        <tr class="odd gradeX" >
                                            ...
                                            <td class="center"><a href="<?php echo base_url();?>index.php/admin/edit_outstation?id6=<?php echo $row1['id'];?>"><i class="fa fa-pencil-square-o"></i></a>&nbsp;&nbsp;<a href="#" title="<?php echo $row1['id'];?>" class="delete"><i class="fa fa-trash-o "></i></a></td>
                                        </tr>
                                       <?php
	   }
									?> 
