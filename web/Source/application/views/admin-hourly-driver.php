...
<html>
  ...
  <?php
								...
								$s = explode(',',$str);
								 ...
								 $query1 = $this->db->query("SELECT * FROM  bookingdetails WHERE purpose='Hourly Rental'  and (status='Processing' or status='Complete') and (item_status='Completed' or item_status='')  ORDER BY id DESC");
								?>
