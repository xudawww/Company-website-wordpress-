...
<html>
 ...
 <?php
								 $query1 = $this->db->query("SELECT * FROM  blogs ORDER BY id DESC");
								?>
       ...
       foreach($query1->result_array('blogs') as $row1){
		...
		?>
                                        ...
                                        <tr class="odd gradeX" >
                                            <td class="center"> <?php echo $row1['block_name'];?></td>
                                           
                                            <td class="center"><a href="<?php echo base_url();?>admin/<?php echo $s;?>?idp=<?php echo $row1['id'];?>" > <i class="fa fa-pencil-square-o"></i></a></td>
                                        </tr>
                                       <?php
	   }
									?> 
