...
<html>
   ...
   <body class="hold-transition skin-blue sidebar-mini">
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <ol class="breadcrumb">
                  ...
                  <li><a href="#">AM</a></li>
                  <li class="active">Edit Airport Details</li>
               </ol>
            </section>
            <!-- Main content -->
            <div class="">
                  ...
                  <div class="col-lg-6">
                     <div class="box box-primary edit_promoform1">
                        <div class="box-header with-border">
                           <h3 class="box-title">Edit Airport Details11</h3>
		 ...
		 $query = $this->db->query("SELECT * FROM  airport_list WHERE  id ='$id'");
		 $row = $query->row(' airport_list');
							   ?>
                         <form role="form"  method="post" id="promocode_reg">
                           <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label>Airport </label>
                                           <input class="form-control " id="signup-username" value="<?php echo $row->name ?>" name="name" >
...
$.ajax({
url:'<?php echo base_url();?>admin/update_airmanage',
type:'post',
data:value,
...
console.log(res);
if(res==1){
		$(".promo-add").html('<p class="success">Airport Details Saved Successfully</p>');
