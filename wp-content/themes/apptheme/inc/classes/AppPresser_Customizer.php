...
class AppPresser_Customizer {
	...
	public function register( $wp_customize ) {
		...
		$wp_customize->add_setting( 'appp_logo', array( 'sanitize_callback' => 'esc_url_raw' ) ); // Add setting for logo uploader
		$wp_customize->add_setting( 'top_menu1_icon', array( 'sanitize_callback' => 'esc_url_raw' ) ); // Top Menu Icon
		$wp_customize->add_setting( 'top_menu2_icon', array( 'sanitize_callback' => 'esc_url_raw' ) ); // Top Menu Icon
		// $wp_customize->add_setting( 'panel_menu_icon', array( 'sanitize_callback' => 'esc_url_raw' ) ); // Top Menu Icon
		...
		foreach ( $this->colors() as $color_mod => $opts ) {
			...
			), array( 'sanitize_callback' => array( $this, 'sanitize_field' ) ) );
			// Controls
	...
	/**
	 * A placeholder for sanitizeing the WP_Customize_Color_Control control
	 */
